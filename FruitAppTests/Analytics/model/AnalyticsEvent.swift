...
class AnalyticsEventTests: XCTestCase {
    ...
    func testDetail_WhenCreatedWithTypeError_returnDetailAsQueryParameter() {
    ...
    func testDetail_WhenCreatedWithTypeDisplay_returnDetailAsQueryParameter() {
    ...
    func testDetail_WhenCreatedWithTypeLoad_returnDetailAsQueryParameter() {
